...
while (true)
{
// опитуємо передаючи в чергу події
// -- клавіатуру
// -- кнопку джойстика
// -- аналогові входи джойстика
// обходимо кінцевий автомат каналів керування
// в активному каналі передаємо 
// -- номер каналу
// -- команду
// -- 4 параметри

// опитуємо клавіатуру
// якщо є натискання передаємо в кільцевий буфер
